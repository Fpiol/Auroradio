...
module.exports = async function afterPack(context) {
  ...
  if (process.platform !== 'win32') {
    console.log('  • skipping Auroradio rcedit injection on non-Windows build host');
    return;
  }
  ...
  execFileSync(rceditPath, [
    exePath,
    '--set-icon', iconPath,
    '--set-version-string', 'FileDescription', 'Auroradio',
    '--set-version-string', 'ProductName', 'Auroradio',
    '--set-version-string', 'CompanyName', 'Auroradio',
